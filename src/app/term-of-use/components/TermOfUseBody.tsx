    ...
    <div className={styles.bodyWrapper}>
      <div className={styles.container}>
        ...
        <section className={styles.section}>
          <h2 className={styles.headingPrimary}>Website Terms of Use</h2>
          <p className={styles.paragraph}>
            Version 1.0<br /><br />
            The datalpse website located at https://www.datalpse.com is a copyrighted work belonging to Nusantara Nyata Digital. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.<br /><br />
        ...
        <section className={styles.section}>
          <h3 className={styles.headingSecondary}>Access to the Site</h3>
          <p className={styles.paragraph}>
            Subject to these Terms. Company grants you a non-transferable, non-exclusive, revocable, limited license to access the Site solely for your own personal, noncommercial use.<br /><br />
            ...
            **No Support or Maintenance.** You agree that Company will have no obligation to provide you with any support in connection with the Site.<br /><br />
            Excluding any User Content that you may provide, you are aware that all the intellectual property rights, including copyrights, patents, trademarks, and trade secrets, in the Site and its content are owned by Company or Company’s suppliers. Note that these Terms and access to the Site do not give you any rights, title or interest in or to any intellectual property rights, except for the limited access rights expressed in Section 2.1. Company and its suppliers reserve all rights not granted in these Terms.
          </p>
        </section>
        
        {/* Section 3: Third-Party Links & Ads; Other Users */}
        <section className={styles.section}>
          <h3 className={styles.headingSecondary}>Third-Party Links & Ads; Other Users</h3>
          <p className={styles.paragraph}>
            ...
            **Cookies and Web Beacons.** Like any other website, datalpse uses &lsquo;cookies&rsquo;. These cookies are used to store information including visitors&rsquo; preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users&rsquo; experience by customizing our web page content based on visitors&rsquo; browser type and/or other information.
          </p>
        </section>
        
        {/* Section 4: Disclaimers */}
        <section className={styles.section}>
          <h3 className={styles.headingSecondary}>Disclaimers</h3>
          <p className={styles.paragraph}>
        ...
        <section className={styles.section}>
          <h3 className={styles.headingSecondary}>Limitation on Liability</h3>
          <p className={styles.paragraph}>
        ...
        <section className={styles.section}>
          <h3 className={styles.headingSecondary}>Copyright Policy.</h3>
          <p className={styles.paragraph}>
        ...
        {/* Section 7: General & Arbitration */}
        <section className={styles.section}>
          <h3 className={styles.headingSecondary}>General</h3>
          <p className={styles.paragraph}>
            ...
            **Applicability of Arbitration Agreement.** All claims and disputes in connection with the Terms or the use of any product or service provided by the Company that cannot be resolved informally or in small claims court shall be resolved by binding arbitration on an individual basis under the terms of this Arbitration Agreement. Unless otherwise agreed to, all arbitration proceedings shall be held in English. This Arbitration Agreement applies to you and the Company, and to any subsidiaries, affiliates, agents, employees, predecessors in interest, successors, and assigns, as well as all authorized or unauthorized users or beneficiaries of services or goods provided under the Terms.
            <br />
            <br />
            **Notice Requirement and Informal Dispute Resolution.** Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief. A Notice to the Company should be sent to: East Java, Malang. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally. If you and the Company do not resolve the claim or dispute within **thirty (30) days** after the Notice is received, either party may begin an arbitration proceeding. The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.
            <br />
            <br />
...
. If any provision of these Terms is held to be invalid or unenforceable, the other provisions of these Terms will be unimpaired and the invalid or unenforceable provision will be deemed modified so that it is valid and enforceable to the maximum extent permitted by law. Your relationship to Company is that of an independent contractor, and neither party is an agent or partner of the other. These Terms, and your rights and obligations herein, may not be assigned, subcontracted, delegated, or otherwise transferred by you without Company’s prior written consent, and any attempted assignment, subcontract, delegation, or transfer in violation of the foregoing will be null and void. Company may freely assign these Terms. The terms and conditions set forth in these Terms shall be binding upon assignees.
        ...
        <section className={styles.section}>
          <h3 className={styles.headingSecondary}>Contact Information</h3>
          <p className={styles.paragraph}>
            Address: Badung, Bali<br /><br />
            Email: info@pejuangtender.com
          </p>
        </section>
