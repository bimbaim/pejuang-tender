// src/lib/emailTemplates/internalSubscriptionNotification.ts
...
export const internalSubscriptionNotificationTemplate = (
  ...
  <head>
    ...
    <title>NOTIFIKASI: Langganan Paket Baru</title>
    <style>
          ...
          <table class="container" width="600" border="0" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#fff;border-radius:10px;overflow:hidden;">
            ...
            <tr>
              <td align="center" style="padding:0 20px 10px;">
                <p style="margin:0;font-size:22px;font-weight:700;color:#28a745;">🎉 NOTIFIKASI INTERNAL 🎉</p>
              </td>
            </tr>

            <tr>
              <td align="center" style="padding:0 20px 20px;">
                <p style="margin:0;font-size:18px;font-weight:700;color:#555;">Langganan Paket Baru Berhasil!</p>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:0 20px;">
                ...
                <p style="margin:0 0 20px;font-size:14px;color:#333;line-height:1.5;text-align:left;">
                  Pelanggan telah berhasil melakukan upgrade/pembelian paket langganan. Berikut adalah detail transaksi dan pelanggan:
                </p>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding:0 20px 20px;">
                <table class="user-table" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse;border:1px solid #ddd;border-radius:8px;overflow:hidden;font-size:14px;">
                  <tr>
                    <th width="30%" style="padding:10px 15px;background:#f0f0f0;font-weight:bold;color:#333;text-align:left;">Nama Pelanggan</th>
              ...
              <td style="padding:0 20px 20px;">
                <div style="background:#e5f4fb;border-radius:8px;padding:15px;text-align:left;">
                  ...
                  <ul style="margin:0;padding-left:20px;font-size:14px;color:#333;line-height:1.5;">
                    <li style="margin-bottom:5px;">Pastikan akses layanan dan email update harian sudah berjalan.</li>
                    <li style="margin-bottom:5px;">Periksa kelengkapan data di sistem CRM.</li>
                    <li>Selamat, pelanggan telah memilih ${packageName}!</li>
                  </ul>
                </div>
              </td>
            </tr>
