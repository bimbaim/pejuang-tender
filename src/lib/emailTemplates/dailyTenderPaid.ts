...
export const dailyTenderPaidEmailTemplate = (
  ...
  const tenderListHtml = tenders
    ...
    <tr style="background-color: #ffffff; border: 1px solid #f5f5f5;">
      ...
      <td style="padding: 8px 15px; border-bottom: 1px solid #e0e0e0; text-align: left; font-size: 13px; font-family: Quicksand, sans-serif; line-height: 19px; color: #333333;">Rp. ${
        tender.budget
      }</td>
